...
exports.generateForm = function(req, res, next){
  var incomingJson = {
    ...
    "cities" : {
      ...
      "type" : "select",
      "class": "form-control",
      "value" : [{ "name" : "Newyork", "value" : "newyork", "selected" : "selected"}, {"name" : "California", "value" : "california"}]
    },
    "colors" : {
      "label" : "Colors",
      "type" : "checkbox",
      "value" : [{ "name" : "Red", "value" : "red", "checked" : "checked"}, {"name" : "Blue", "value" : "blue"}, {"name" : "Green", "value" : "green"}]
    },
    "gender" : {
      "label" : "Gender",
      "type" : "radio",
      "value" : [{ "name" : "Male", "value" : "male", "checked" : "checked"}, {"name" : "Female", "value" : "female"}]
    },
		"button": {
			"type": "submit",
